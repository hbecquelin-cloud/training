CREATE OR REPLACE TABLE carteldeladata.modelisation_travel.fact_travel_car_booking AS (
...
WITH flattened_car_hires AS (
    SELECT DISTINCT
        ...
        car_model_name,
        payment_done_at       
    FROM carteldeladata.modelisation_sources.car_hires
...
LEFT JOIN carteldeladata.modelisation_sources.car_rental_companies AS car_rental_companies
